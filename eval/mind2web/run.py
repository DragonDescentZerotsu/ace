...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='ACE System - Mind2Web')

    # Task configuration
    parser.add_argument("--task_name", type=str, required=True,
                        help="Name of the task (e.g., 'mind2web', 'mind2web_small')")
...
def main():
    ...
    # Load data
    with open("./eval/mind2web/data/sample_config.json", 'r') as f:
    ...
    # (run eval_only separately with the learned playbook afterward)
